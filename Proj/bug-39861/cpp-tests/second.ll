...
define zeroext i1 @_Z3srccc(i8 %x, i8 %y) {
  %tmp0 = lshr i8 255, %y
  %tmp1 = and i8 %tmp0, %x
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define zeroext i1 @_Z3tgtcc(i8 %x, i8 %y) {
  %tmp0 = lshr i8 255, %y
...
33:                                               ; preds = %30, %27
  ...
  %40 = call zeroext i1 @_Z3srccc(i8 signext %38, i8 signext %39)
  ...
  %49 = call zeroext i1 @_Z3tgtcc(i8 signext %47, i8 signext %48)
...
59:                                               ; preds = %8
  ...
  %66 = call zeroext i1 @_Z3srccc(i8 signext %64, i8 signext %65)
  ...
  %75 = call zeroext i1 @_Z3tgtcc(i8 signext %73, i8 signext %74)

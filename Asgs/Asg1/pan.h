...
#define PanSource	"bubble_sort_wrong.pml"
...
#define _nstates0	58	/* bubsort */
#define minseq0	0
#define maxseq0	56
#define _endstate0	57
...
#define Pbubsort	((P0 *)_this)
typedef struct P0 { /* bubsort */
...
#define Air0	(sizeof(P0) - Offsetof(P0, t) - 1*sizeof(uchar))
